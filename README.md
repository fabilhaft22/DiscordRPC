...
If you want to make your life a bit easier, you can download the [exe](https://github.com/fabilhaft22/DiscordRPC/releases/tag/v1.0.0-2exe) to skip the steps of installing nodejs and the packages      
